...
electrolyzer.recipeBuilder().inputs([<contenttweaker:worldgenblock> * 4]).outputs([<minecraft:cobblestone> * 4, <contenttweaker:bluedust>]).duration(100).EUt(16).buildAndRegister();
